...
<body>
  ...
  <input class="form-check-input" type="radio" name="ugender" id="inlineRadio1" value="남자">
  <label class="form-check-label" for="inlineRadio1">남자</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" name="ugender" id="inlineRadio2" value="여자">
